        ...
        <div class="game-content" v-show="room.status == 'playing'">
          ...
          <div class="tool-bar">
            <ul class="color-list canselected">
              <li :class="{current: currentColor == color }" :style="{background: color}" v-for="color in colors" @click="currentColor=color"></li>

            </ul>
            <ul class="line-box canselected">
              <li :class="{current: currentWeight == weight }" v-for="weight in weights" @click="currentWeight=weight">
                <div :style="{width: weight, height: weight}" ></div>
              </li>
            </ul>
            <div class="small-btn rubber-btn" @click="rubber"></div>
            <div class="small-btn clear-btn" @click="clearCas"></div>
          </div>
        </div>
        <div class="right-box">
          <div class="chat-box">
